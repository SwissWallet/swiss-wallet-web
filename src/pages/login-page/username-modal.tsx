                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex justify-center flex-col items-center gap-1">
                            <input type="email" placeholder="Insira seu e-mail" 
                                className="outline-none rounded-md p-1 w-full font-medium placeholder-slate-400
                                    focus:not-italic focus:outline-red-600 placeholder:font-light placeholder:italic" 
                            />
                            <a>
